                ...
                <div class="card-header card-header-primary d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <p class="card-category"><a
                                href="{{ route('phonebooks.edit', $phonebook->id) }}">{{ $phonebook->title }}</a></p>
                    </div>
                    <search-contacts phonebook-id="{{$phonebook->id}}" base-url="{{ config('app.url') }}">
                    </search-contacts>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><img src="{{ strlen($contact->photo) ? $contact->photo : '/img/no-photo.svg' }}"
                                    ...
                                    <td class="td-actions text-right">
                                        <a href="{{ route('contacts.edit', [$phonebook->id, $contact->id]) }}"
                                            rel="tooltip" title="Открыть для редактирования"
