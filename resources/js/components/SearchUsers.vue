  ...
  <div class="mr-auto ml-4 w-50">
    <form action="#" class="search-form">
      <div class="form-group">
        <label class="bmd-label-floating d-flex align-items-center"><i class="material-icons">search</i> Поиск по пользователям</label>
...
<script>
  ...
  export default {
    ...
    methods: {
        fetch() {
            axios.get('/api/search/users', { params: { search: this.search } })
                .then((response) => {
